...
class RespectifyClientAsync {
    ...
    */
    ...
    /**
     * Check user credentials and return subscription status.
     ...
     *
     * @return PromiseInterface<UserCheckResponse> A promise that resolves to a UserCheckResponse containing:
     *   - active: bool - Whether subscription is active
     *   - status: string|null - Current subscription status
     *   - expires: string|null - Subscription expiration date
     *   - plan_name: string|null - Name of the subscription plan
     *   - allowed_endpoints: array|null - List of API endpoints allowed for this plan
     *   - error: string|null - Error message if subscription check failed
     * @throws RespectifyException
     * @throws JsonDecodingException
     */
    public function checkUserCredentials(): PromiseInterface {
        return $this->client->get(
            ...
            try {
                $responseData = json_decode((string)$response->getBody(), true);
                if (isset($responseData['active'])) {
                    return new UserCheckResponse($responseData);
                } else {
